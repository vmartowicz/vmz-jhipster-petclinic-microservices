...
/**
 * Criteria class for the {@link fr.vmz.jhipster.petclinic.customer.domain.Pet} entity. This class is used
 * in {@link fr.vmz.jhipster.petclinic.customer.web.rest.PetResource} to receive all the possible filtering options from
...
public class PetCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, birthDate, typeId, ownerId, distinct);
    }
